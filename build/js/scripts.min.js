...
!function(e,t){"use strict";var n=e.navigator.userAgent.toLowerCase();if(/trident/gi.test(n)||/msie/gi.test(n)){for(var o,r=t.querySelectorAll("use"),i=0;i<r.length;i++)o="#"+(o=r[i].getAttribute("xlink:href")).split("#")[1],r[i].setAttribute("xlink:href",o);if(!t.createElementNS||!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var a,l,s="localStorage"in e&&null!==e.localStorage,c=function(){t.body.insertAdjacentHTML("afterbegin",l)},g=function(){t.body?c():t.addEventListener("DOMContentLoaded",c)};if(s&&5==localStorage.getItem("inlineSVGrev")&&(l=localStorage.getItem("inlineSVGdata")))return g();try{(a=new XMLHttpRequest).open("GET","img/svg/symbol/sprite.svg",!0),a.onload=function(){200<=a.status&&a.status<400&&(l=a.responseText,g(),s&&(localStorage.setItem("inlineSVGdata",l),localStorage.setItem("inlineSVGrev",5)))},a.send()}catch(e){}}}(window,document),window.onload=function(){};
$(document).ready(function(){var i=window.navigator.userAgent.toLowerCase();if(/trident/gi.test(i)||/msie/gi.test(i)){document.createElement("picture"),$("symbol").parent().attr("style","display: none;");var o=!1,s=$(".social__icon");s.on("mousedown",function(){$(this).css({opacity:.1}),o=!0}),s.on("mouseout",function(){$(this).css({opacity:.3}),o&&($(this).children().css("opacity",1),o=!1)}),s.on("mousemove",function(){o||$(this).css({opacity:1})});var t=!1,n=$(".main-footer__author-icon");n.on("mousedown",function(){$(this).css({opacity:.1}),t=!0}),n.on("mouseout",function(){$(this).css("opacity",1),t=!1}),n.on("mousemove",function(){t||$(this).css({opacity:.3})});var c=$(".categories__link");c.on("mousedown",function(){$(this).children(".categories__icon").css("fill","rgba(0, 0, 0, 0.1)"),$(this).children(".categories__subtitle").css("opacity",.1)}),c.on("mouseout",function(){$(this).children(".categories__icon").css("fill","rgba(0, 0, 0, 1)"),$(this).children(".categories__subtitle").css("opacity",1)}),$(".search__field").css("padding","8px 38px 19px"),$(".write__field").css("padding","3px 20px 16px")}});
$(document).ready(function(){$(".slider").slick({dots:!0,arrows:!1,infinite:!0,speed:300,slidesToShow:1});var t=new Popup({popup:".modal__popup",closeModal:".modal__popup-close",overlay:".modal__overlay"});$(".contacts__map-link").on("click",function(o){o.preventDefault(),t.open($(".modal__map"))}),$(".contacts__link").on("click",function(o){o.preventDefault(),t.open($(".modal__write"))}),$(".option").removeClass("product__option--nojs"),$(".product").hover(function(){$(this).children(".option").slideDown()},function(){$(this).children(".option").slideUp()});var n=$(".catalog__list");n.removeClass("no-js"),$("html:not(.catalog__list):not(.catalog__title)").on("click",function(o){n.css("display","none")}),$(".catalog__title").on("click",function(o){o.stopPropagation(),"flex"==n.css("display")?n.css("display","none"):n.css("display","flex")}),n.on("click",function(o){o.stopPropagation(),n.css("display","flex")});var o=$(".features__item");o.on("click",function(){o.removeClass("features__item--active"),$(this).addClass("features__item--active")})});